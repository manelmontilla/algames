...
namespace ALGAMES.MatrixBoardGames
{
    public class MatrixBoardGameBackTracking
    {
        const int WINROWLEGTH = 3;
         public MatrixBoarGameConf Conf{get;private set;} 
         
         public MatrixBoardGameBackTracking(MatrixBoarGameConf Conf)
         {
             this.Conf=Conf;
         }
        ...
        int WinId, int LoseId, out int next)
        {
           ...
           var searchList = this.Conf.GetFreePositions(CurrentBoard, NumberOfMovsDone);
